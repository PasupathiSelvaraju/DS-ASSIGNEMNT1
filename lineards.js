console.log(" DS-Assignment-1: Linear Data Structures");
...
console.log("QUESTION NO-1:" + " " + getPairsCount(arr, n, sum));

//Q2. Write a program to reverse an array in place? In place means you cannot create a new array. You have to update the original array
var arr1 = [1, 2, 3, 4, 5];
var rev = arr1.reverse();
console.log("QUESTION NO-2:" + " " + rev);
...
if (areRotations(str1, str2))
    console.log("QUESTION NO-3:" + " " + "Strings are rotations of each other");
else
    console.log("QUESTION NO-3:" + " " + "Strings are not rotations of each other");
...
console.log("QUESTION NO-4:" + " " + find_FirstNotRepeatedChar("abacddbec"));
...
function towerOfHanoi(n1, from_rod, to_rod, aux_rod) {
    ...
    console.log(
        "QUESTION NO-5:" + " " + "Move disk " + n + " from rod " + from_rod + " to rod " + to_rod + "<br/>"
    );
...
// Function call
console.log("QUESTION NO-6:" + " " + "Prefix : " + postToPre(post_exp));
...
console.log("QUESTION NO-7:" + " " + "Infix : " + convert(exp));
...
// Function call
if (areBracketsBalanced(expr)) console.log("QUESTION NO-8:" + " " + "Balanced ");
else console.log("QUESTION NO-8:" + " " + "Not Balanced ");
...
console.log("QUESTION NO-9:" + " " + "Original Stack");
...
console.log("QUESTION NO-9:" + " " + "Reversed Stack");
...
console.log("QUESTION NO-10:" + " " + "smallest element is " + arr4[0], "");
